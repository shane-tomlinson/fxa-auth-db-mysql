...
module.exports = function (log, error) {
  ...
  Memory.prototype.createSigninCode = (code, uid, createdAt, flowId, signinCodeData) => {
    ...
    signinCodes[code] = { uid, createdAt, flowId, signinCodeData }
  ...
  Memory.prototype.consumeSigninCode = code => {
    ...
    const signinCodeData = signinCodes[code].signinCodeData
    delete signinCodes[code]

    return P.resolve({ email, flowId, signinCodeData })
  }
